...
function AboutCta() {
  return (
    <section>
      <div className=" container-wrapper border  rounded-xl border-prime mb-4">
        <div className=" p-4">
          <h1 className=" txt-grad sm:text-5xl text-3xl font-bold text-center py-3">
          The ZoctorAI Difference
          </h1>
